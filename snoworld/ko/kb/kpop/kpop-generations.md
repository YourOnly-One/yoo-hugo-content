...
K-pop을 다른 세대로 나누는 방법에 대한 많은 제안이 있지만 불행히도 대부분은 주관적입니다. 주관적인 접근 방식에는 문제가 없지만 적어도 공통 기반이나 출발점으로 우리 모두 또는 대부분이 동의할 수 있는 것이 필요합니다. *K-pop Generations*에 대한 **YourOnly.One**의 객관적인 접근 방식을 소개하겠습니다.
