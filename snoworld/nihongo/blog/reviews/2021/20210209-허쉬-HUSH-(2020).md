...
disqus_url = "https://youronly.one/snoworld/hush-2020-202140/"																										# canonical URL for disqus
#disqus_identifier = ""																						# unique identifier variable; usually automatic and not needed

channels = ["Snoworld"]
categories = ["TV"]																									# taxonomy
keywords = ["H.U.S.H.", "허쉬"]																										# meta keywords
...
{{< image
  ...
  imgtitle="ハーシー (2020)"
  imgcaption="Hwang Jung Min as Han Jook Hyuk (左); Im Yoon Ah as Lee Ji Soo (右)"
  imgalt="ハーシー (2020) Hwang Jung Min as Han Jook Hyuk (左); Im Yoon Ah as Lee Ji Soo (右)"
...
{{< youtube id="vzT1vMHc5fQ" title="「ハーシー」 (2020) 予告編" >}}
