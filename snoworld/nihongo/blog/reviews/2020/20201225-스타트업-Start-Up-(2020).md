...
disqus_url = "https://youronly.one/snoworld/start-up-2020-2020360/"															# canonical URL for disqus
#disqus_identifier = ""											# unique identifier variable; usually automatic and not needed

channels = ["Snoworld"]
categories = ["TV"]														# taxonomy
keywords = ["스타트업", "Start-Up", "K-Drama"]															# meta keywords
...
{{< image
  ...
  imgtitle="スタートアップ (2020)"
  imgcaption="(左から右へ) 「Suzy」、「Nam Joo Hyuk」、「Kim Seon Ho」、「Kang Han Na」"
  imgalt="スタートアップ (2020) (左から右へ) 「Suzy」、「Nam Joo Hyuk」、「Kim Seon Ho」、「Kang Han Na」"
...
## 公式予告編
{{< youtube id="Lu3o0XrlsAg" title="「スタートアップ」 予告編" >}}
