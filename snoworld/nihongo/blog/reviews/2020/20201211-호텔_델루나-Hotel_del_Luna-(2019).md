...
disqus_url = "https://youronly.one/snoworld/hotel-del-luna-2019-2020346/"															# canonical URL for disqus
#disqus_identifier = ""											# unique identifier variable; usually automatic and not needed

channels = ["Snoworld"]
categories = ["TV"]														# taxonomy
keywords = ["호텔 델루나", "Hotel del Luna", "K-Drama"]															# meta keywords
...
{{< image
  ...
  imgtitle="ホテルデルルナ (2019)"
  imgcaption="Lee Ji Eun as Jang Man Wol (left); Yeo Jin Goo as Goo Chan Sung (right)"
  imgalt="ホテルデルルナ (2019) Lee Ji Eun as Jang Man Wol (left); Yeo Jin Goo as Goo Chan Sung (right)"
...
## 公式予告編
{{< youtube id="arcoS89uGLA" title="「ホテルデルルナ」 予告編" >}}
