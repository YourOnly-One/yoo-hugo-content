...
disqus_url = "https://youronly.one/love/the-choice-2016-2016185/"                                                    # canonical URL for disqus
#disqus_identifier = ""																						# unique identifier variable; usually automatic and not needed

channels = ["Love and Relationship"]
categories = ["Films"]																									# taxonomy
keywords = ["The Choice", "Nicholas Sparks"]																										# meta keywords
...
私がいつも言うように、 ***[愛は選択です、それは決定です]({{< ref "/20160221-true-definition-of-love.md" >}})</a>***.

私はこの映画化に10つ星のうち9つを与えます。 強くお勧めします。

{{< youtube id="nWPM1jTnuuo" title="「選択肢」 (2016) 予告編" >}}
